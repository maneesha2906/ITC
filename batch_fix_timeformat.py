...
# ✅ Start Spark Session
spark = SparkSession.builder.appName("batch_fix_timeformat").enableHiveSupport().getOrCreate()

# ✅ Define Hive Database & Tables
HIVE_DB = "default"
SOURCE_TABLE = "tfl_underground_result_"
TARGET_TABLE = "tfl_underground_result_fixed"
...
df = df.withColumn("timedetails", to_timestamp(col("timedetails")))  # Convert to timestamp
